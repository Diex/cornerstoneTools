...
/**
 * @public
 * @class ChestProthesisTool
 * @memberof Tools.Annotation
 * @classdesc Tool for visualize a chest prothesis.
 * @extends Tools.Base.BaseAnnotationTool
 */
export default class ChestProthesisTool extends BaseAnnotationTool {
  constructor(props = {}) {
    const defaultProps = {
      name: 'ChestProthesisTool',
